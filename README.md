...
* 공유 덱 등록 기능 - 글제목,글내용을 입력할 수 있고 해당 계정에 등록된 덱 리스트가 출력되서 클릭시 해당 덱정보가 게시글에 등록된다.(비로그인시 등록버튼 안보임)
* 공유 덱 게시글에 댓글 등록 기능
* 공유 덱 리스트 조회수 체크
* 공유 덱 이름으로 리스트 검색 기능
* 추가될 기능) 대댓글,내글 삭제
...
# 패치노트 v1.7(2023-08-14)
## 오류수정 및 추가기능 개발
### 덱 만들기 기능
* 카드 리스트가 안뜨는 현상 확인 - 수정
### 공유 덱 리스트
![sharedComment](https://github.com/jungtaemin/kanatales_deckmaker/assets/96284736/1c442987-b16f-4a6e-91b0-e61e8dd2690c)
* 댓글 등록 기능 추가
...
## 오류수정 및 추가기능 개발
### 카나테일즈 카드 DB
* 카드의 태그 값 없을시 null로 표기됨 - 수정
### 가챠 시뮬레이터
* 가챠 종류 미선택시 구성품확인,등급별카드확률,구매하기버튼 클릭시 에러 ->가챠 종류를 선택해주세요 얼럿뜨게 수정
* 가챠 종류 변경시 가챠결과 및 가챠 수량 초기화되게 수정
### 공유 덱 리스트
* 조회순 최신순 기능 추가 - 검색후에도 해당 결과만 조회순 최신순 출력
* 덱 리스트 검색 안됨 - 수정
* 덱 리스트 rownum 추가
