...
* 구현 예정
  ...
  * ~~**로그기능** - 로그로 남겨야할 정도의 비정상적 접근.로그로 남기는 기능.~~(2023-06-22 로그를 파일로 저장하는 방식으로 구현완료)(로그 모니터링 툴이나 그런 다른 방식 고려해볼것.)
  * **aws 로 사이트 배포하기**(2023-06-22 현재 가장 우선으로 계속 공부중.)
# 최종 구현 기능
## 덱 만들기 기능
